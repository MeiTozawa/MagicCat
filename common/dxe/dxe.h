...
namespace dxe {
	...
	// app の立ち上がりフレームを取得
	DXE_PROTOTYPE_GET_APP_START_FRAME;
	...
	// 一般的なワールドセッティングを保存
	DXE_PROTOTYPE_SAVE_WORLD_ORDINARY_SETTING;

	// 一般的なワールドセッティングを読み込み
	DXE_PROTOTYPE_LOAD_WORLD_ORDINARY_SETTING;

	// 一般的なワールドセッティングGUIを描画
	DXE_PROTOTYPE_DRAW_IMGUI_WORLD_ORDINARY_SETTING;
