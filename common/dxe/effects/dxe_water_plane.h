...
namespace dxe {
	...
	public :
		...
		//-----------------------------------------------------------------------------------------------------------------------------------------------------
		// リソースからのロード
		WaterPlane(const std::wstring& file_path);
		...
		//-----------------------------------------------------------------------------------------------------------------------------------------------------
		void loadPatternTexture(const std::wstring& pattern_texture_path);
		
		//-----------------------------------------------------------------------------------------------------------------------------------------------------
		void loadDecorationTexture(const std::wstring& decoration_texture_path);
	...
	private :
		...
		std::wstring pat_tex_path_;
		std::wstring dec_tex_path_;
