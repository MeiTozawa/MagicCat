...
namespace tnl {
	...
	//------------------------------------------------------------------------------------------------------------------------
	Vector3::Vector3(const tnl::Vector2f& v) noexcept : DirectX::XMFLOAT3(v.x, v.y, 0) {}
	...
	Vector3 Vector3::Random(
		...
		Vector3 v = {
			tnl::GetRandomDistribution<float>(min_x, max_x),
			tnl::GetRandomDistribution<float>(min_y, max_y),
			tnl::GetRandomDistribution<float>(min_z, max_z)
		};
		return v;
	}
	...
	tnl::Vector3 Vector3::RandomAxis(const tnl::Vector3& base_axis, float limit_angle) noexcept {
		...
		float angle = tnl::GetRandomDistribution<float>(-limit_angle, limit_angle);
		...
		angle = tnl::GetRandomDistribution<float>(-90.0f, 90.0f);
