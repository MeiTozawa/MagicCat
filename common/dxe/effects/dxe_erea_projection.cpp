...
namespace dxe {
        ...
        , const bool have_blur_tex)
    {
        ...
        vertex_shader_hdl_ = LoadVertexShader(L"resource/shader/dxe/erea_projection.vso");
        pixel_shader_hdl_ = LoadPixelShader(L"resource/shader/dxe/erea_projection.pso");
