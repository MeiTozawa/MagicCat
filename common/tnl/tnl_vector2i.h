...
namespace tnl {
	...
	public :
		...
		explicit Vector2i(int32_t xy) noexcept : DirectX::XMINT2(xy, xy) {}
		explicit Vector2i(float xy) noexcept : DirectX::XMINT2((int32_t)xy, (int32_t)xy) {}
		...
		explicit Vector2i(const tnl::Vector3& v) noexcept;
		explicit Vector2i(const tnl::Vector2f& v) noexcept;


		static const Vector2i left() { static const Vector2i instance(-1, 0); return instance; }
		static const Vector2i right() { static const Vector2i instance(1, 0); return instance; }
		static const Vector2i up() { static const Vector2i instance(0, -1); return instance; }
		static const Vector2i down() { static const Vector2i instance(0, 1); return instance; }
	...
	//-----------------------------------------------------------------------------------------------------
	inline std::wstring Vector2i::toString() const noexcept {
		std::wstring str = L"[ x : ";
		str += std::to_wstring(this->x);
		str += L" ] [ y : ";
		str += std::to_wstring(this->y);
		str += L" ] ";
		return str;
	}
