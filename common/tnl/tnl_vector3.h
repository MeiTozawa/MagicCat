...
namespace tnl {
	...
	public :	
		...
		explicit Vector3(const DirectX::XMFLOAT3& v) noexcept : DirectX::XMFLOAT3(v.x, v.y, v.z) {}
		explicit Vector3(const tnl::Vector2i& v) noexcept ;
		explicit Vector3(const tnl::Vector2f& v) noexcept;

		static const Vector3 forward() { static const Vector3 instance(0, 0, 1); return instance; }
		static const Vector3 back() { static const Vector3 instance(0, 0, -1); return instance; }
		static const Vector3 left() { static const Vector3 instance(-1, 0, 0); return instance; }
		static const Vector3 right() { static const Vector3 instance(1, 0, 0); return instance; }
		static const Vector3 up(){ static const Vector3 instance(0, 1, 0); return instance; }
		static const Vector3 down() { static const Vector3 instance(0, -1, 0); return instance; }
		...
		inline static const Vector3& Axis(eAxis type) { return axis[static_cast<uint32_t>(type)]; }
		inline static const Vector3 Axis(fAxis flags) {
			Vector3 ret = { 0, 0, 0 };
	...
	//-----------------------------------------------------------------------------------------------------
	inline std::wstring Vector3::toString(const std::wstring& format) const noexcept {
		std::wstring str = L"[ x : ";
