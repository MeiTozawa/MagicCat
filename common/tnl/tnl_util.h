...
namespace tnl{
	...
	std::tuple<std::wstring, std::wstring, std::wstring> DetachmentFilePath( const std::wstring& file_path );
	...
	// float -> wstring 変換 ( フォーマット指定付き )
	std::wstring FloatToString(float value, const std::wstring& fmt = L"%f");
